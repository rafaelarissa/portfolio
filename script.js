...
clickSobre.addEventListener("click", function (event) {
  ...
  conteudo.innerHTML =
    "<div class=sobreMim><div><p>👋 Oi, meu nome é Rafaela — sou brasileira, nascida e criada em Natal, RN, a cidade do sol.</p><img src='natal-rn.jpg' alt=Natal/RN></div><div><p>📚 Sou paixonada por romances policiais, mas também aprecio gêneros como ficção e romance. Minha escritora favorita é a Agatha Christie, que sempre me consegue surpreender com suas obras.</p><img src='agatha-christie.jpg' alt=Descrição da imagem></div><div><p>🎮 No meu tempo livre, gosto de jogar, e normalmente escolho desafios que exercitem a lógica e o raciocínio — sejam quebra-cabeças ou enigmas intricados. Também aprecio RPGs eletrônicos e jogos 2D de aventura e plataforma.</p><img src='grandchase.png' alt=Descrição da imagem></div><div><p>🐾 Tenho dois gatinhos que são verdadeiros parceiros de vida: Luffy e Ace (Romeu). Eles acompanham minha rotina diariamente.</p><img src='cats.jpg' alt=Descrição da imagem></div>";
